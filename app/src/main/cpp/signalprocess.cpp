...
extern "C"
JNIEXPORT void
Java_cn_dmrf_nuaa_gamebird_Gesture_SignalProcess_DemoNew(
        JNIEnv *env,
        jobject /* this */
) {
    if (demo_data != NULL)
...
extern "C"
JNIEXPORT jdouble
Java_cn_dmrf_nuaa_gamebird_Gesture_SignalProcess_DemoL(
        JNIEnv *env,
        jobject /* this */,
        jshortArray BUFF,
        jdoubleArray REDist,
...
extern "C"
JNIEXPORT jdouble
Java_cn_dmrf_nuaa_gamebird_Gesture_SignalProcess_DemoR(
        JNIEnv *env,
        jobject /* this */,
        jshortArray BUFF,
        jdoubleArray REDist,
...
extern "C"
JNIEXPORT void
Java_cn_dmrf_nuaa_gamebird_Gesture_SignalProcess_Normalize(JNIEnv *env,
                                                                 jobject /* this */,
                                                                 jfloatArray I,
                                                                 jfloatArray Q) {
